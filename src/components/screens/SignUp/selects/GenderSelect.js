...
export default function GenderSelect({ onPress, selectedGender }) {
  const handleSelectGender = (selectedGender) => {
    if (selectedGender === 'None') return 'Không chia sẻ';
    else if (selectedGender === 'Male') return 'Nam';
    else if (selectedGender === 'Female') return 'Nữ';
    else return 'Giới tính';
  };
  return (
    <TouchableOpacity
      style={{
    ...
    >
      <Text
        style={{
          ...
          color: selectedGender === 'nothing' ? Colors.grey : Colors.primary,
        }}
      >
